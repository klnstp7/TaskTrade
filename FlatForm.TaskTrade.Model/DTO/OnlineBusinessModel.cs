...
{
    public class OnLineBusinessModel
    {
        /// <summary>
        /// 主键
        /// </summary>
        ...
        /// 业务反馈
        /// </summary>
        public ICollection<OnLineFeedBackModel> OnLineFeedBacks { get; set; }


        /// <summary>
        /// 资料
        /// </summary>
        public ICollection<ProjectDocumentModel> ProjectDocuments { get; set; }

        /// <summary>
        /// 银行
        /// </summary>
        public ICollection<OnLineBusinessBankModel> OnLineBusinessBanks { get; set; }
