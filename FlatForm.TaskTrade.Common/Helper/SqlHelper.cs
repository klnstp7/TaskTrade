...
namespace Peacock.Common.Helper
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static readonly string connectionString = System.Configuration.ConfigurationSettings.AppSettings["ReadConnection"].ToString().Trim();
        ...
        /// <param name="commandParameters">以数组形式提供SqlCommand命令中用到的参数列表</param>
        /// <returns>返回一个表集合(DataTableCollection)表示查询得到的数据集</returns>
        public static DataTableCollection GetTableProcedure(string cmdText, SqlParameter[] commandParameters)
        {
